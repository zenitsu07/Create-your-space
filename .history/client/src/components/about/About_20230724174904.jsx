    ...
    return (
        ...
        <Box>
            ...
            <Wrapper>
                ...
                <Text variant="h3" style={{fontWeight: 'bold'}}>About Create_your_space Intiative</Text>

                <Flex  variant='h6' className='pd-10'>

                    Welcome to Create Your Space, a one-of-a-kind blog app designed to empower individuals to express themselves and share their unique perspectives with the world. 
                    <br></br>Our mission is to provide a platform where users can create their own digital sanctuaries, curate content that resonates with them, and connect with like-minded individuals.
