...
const Login = ({isUserAuthenticated}) => {
    ...
    const imageURL = "E:\mern\Blogs\client\src\components\account\logo-blog-sesta-trasparente.png"
    //Import setAccount 
           ...
           <Box>
                ...
                {account === "login"?
                    ...
                    <Wrapper>
                        ...
                        <SignUpButton variant="outlined" onClick= {() => toggleSignup()} style={{ marginBottom: 50 }} > Create an account</SignUpButton>
