...
const Image = styled(Box)`
    ...
    background-image: "https://images.unsplash.com/photo-1569228488691-3e94a47d8f5d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60" center/55%  #000;
    height: 50%;
    display: flex;
